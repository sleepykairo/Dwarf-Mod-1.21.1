...
public class BlackPowderTntEntity extends Entity implements Ownable {
    private static final TrackedData<Integer> FUSE = DataTracker.registerData(BlackPowderTntEntity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<BlockState> BLOCK_STATE = DataTracker.registerData(BlackPowderTntEntity.class, TrackedDataHandlerRegistry.BLOCK_STATE);
    ...
    public BlackPowderTntEntity(EntityType<? extends BlackPowderTntEntity> entityType, World world) {
        super(entityType, world);
        this.intersectionChecked = true;
    }

    public BlackPowderTntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(ModEntities.BLACK_POWDER_TNT_ENTITY, world);
    ...
    public void copyFrom(Entity original) {
        ...
        if (original instanceof BlackPowderTntEntity tntEntity) {
    ...
    public Entity teleportTo(TeleportTarget teleportTarget) {
        ...
        if (entity instanceof BlackPowderTntEntity tntEntity) {
