...
public class MithrilMinecartEntityRenderer<T extends AbstractMinecartEntity> extends EntityRenderer<T> {
    private static final Identifier TEXTURE = Identifier.of(DwarfMod.MOD_ID,"textures/entity/mithril_minecart.png");
